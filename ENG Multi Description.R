#This code performs descriptive statistics for the propensity-matched cohort
#of patients enrolled in ENGAGES and control SATISFY-SOS patients (Table 1)

#Created by Bradley Fritz on 02/03/2021
#Last updated by Bradley Fritz on 02/24/2021
###############################################
...
#write.xlsx(desc,'ENGAGES Multi Results.xlsx',sheetName='Description',append=T,row.names = F)